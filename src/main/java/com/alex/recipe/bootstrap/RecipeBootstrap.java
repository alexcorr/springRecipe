package com.alex.recipe.bootstrap;
...
import com.alex.recipe.repositories.CategoryRepository;
import com.alex.recipe.repositories.RecipeRepository;
import com.alex.recipe.repositories.UnitOfMeasureRepository;

import com.alex.recipe.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	public RecipeBootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository,
		...
		System.out.println("constructor recipebootstrap");
	}
	
	
	@Override
	public void onApplicationEvent(ContextRefreshedEvent arg0) {
		System.out.println("onAppEvent");
